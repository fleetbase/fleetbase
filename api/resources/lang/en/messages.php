...
return [
    ...
    'partial_success' => 'Import processed with errors. Download the error log, fix the errors, and try again.',
    'full_import_error' => 'Import failed. Download the error log, fix the errors, and try again.',
