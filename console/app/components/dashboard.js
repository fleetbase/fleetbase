...
export default class DashboardComponent extends Component {
     ...
     */
    constructor(owner, { defaultDashboardId = 'dashboard', defaultDashboardName = null, showPanelWhenZeroWidgets = false, extension = 'core' } = {}) {
        super(...arguments);
        if (!defaultDashboardName) {
            defaultDashboardName = this.intl.t('dashboard.default_dashboard');
        }
