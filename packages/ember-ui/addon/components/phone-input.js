...
export default class PhoneInputComponent extends Component {
    ...
    @action handleInput(event) {
        ...
        // Ensure the '+' sign is always at the start
        if (!inputValue.startsWith('+')) {
            inputValue = '+44' + inputValue.replace(/[^0-9]/g, ''); // Keep only numeric values
        }

        // Update the input value without triggering infinite loops
