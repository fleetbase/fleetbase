...
export default class ManagementTollReportsIndexEditController extends BaseController {
    /**
     * Inject the `hostRouter` service
     *
     * @memberof ManagementTollReportIndexEditController
     */
    @service hostRouter;
        ...
        if (fuelReport.hasDirtyAttributes) {
            return this.confirmContinueWithUnsavedChanges(fuelReport, {
                confirm: () => {
                    ...
                    return this.transitionToRoute('management.toll-reports.index');
                },
            });
        }
    ...
    @action onViewDetails(fuelReport) {
        ...
        return this.transitionToRoute('management.toll-reports.index.details', fuelReport);
    }
    ...
    confirmContinueWithUnsavedChanges(fuelReport, options = {}) {
        return this.modalsManager.confirm({
            ...
            body: this.intl.t('fleet-ops.management.toll-reports.index.edit.body'),
