 ...
 * @extends Controller
 */
export default class ManagementTollReportsIndexDetailsController extends BaseController {
    @service hostRouter;
    ...
    @action onEdit(fuelReport) {
        return this.transitionToRoute('management.toll-reports.index.edit', fuelReport);
    }
