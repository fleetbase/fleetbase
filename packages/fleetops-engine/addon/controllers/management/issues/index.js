...
export default class ManagementIssuesIndexController extends BaseController {
    ...
    @tracked columns = [
        ...
        },
        {
            ...
            filterComponentPlaceholder: this.intl.t('fleet-ops.component.issue-form-panel.select-reporter'),
        ...
        },
        {
            ...
            filterable: true,
            filterComponent: 'filter/model',
            filterComponentPlaceholder: this.intl.t('fleet-ops.component.issue-form-panel.select-assign'),
        ...
        },
        {
            ...
            filterable: true,
            filterComponent: 'filter/model',
            filterComponentPlaceholder: this.intl.t('fleet-ops.component.issue-form-panel.select-driver'),
            filterParam: 'driver',
            model: 'driver',
        },
        {
            ...
            filterable: true,
            filterComponent: 'filter/model',
            filterComponentPlaceholder: this.intl.t('fleet-ops.component.issue-form-panel.select-vehicle'),
            filterParam: 'vehicle',
            model: 'vehicle',
