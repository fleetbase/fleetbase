 ...
 * @extends Controller
 */
export default class ManagementParkingIndexDetailsController extends BaseController {
    @service hostRouter;
    ...
    @action onEdit(fuelReport) {
        return this.transitionToRoute('management.parking.index.edit', fuelReport);
    }
