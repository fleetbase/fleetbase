...
export default class ManagementParkingIndexController extends BaseController {
    ...
    @tracked columns = [
        ...
        },
        {
            ...
            actions: [
                {
                    label: this.intl.t('fleet-ops.management.parking.index.view'),
                ...
                {
                    label: this.intl.t('fleet-ops.management.parking.index.delete'),
    ...
    @action viewFuelReport(fuelReport) {
        this.transitionToRoute('management.parking.index.details', fuelReport);
    }
    ...
    @action createFuelReport() {
        this.transitionToRoute('management.parking.index.new');
    }
    ...
    @action editFuelReport(fuelReport) {
        this.transitionToRoute('management.parking.index.edit', fuelReport);
    }
